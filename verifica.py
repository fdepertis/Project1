...
print("----------------------------TEST-MERGE---------------------")
cpl_sorted = cpl.bubble_sorted()
cpl3_sorted = cpl3.bubble_sorted()
print("----->lista1",str(cpl_sorted))
print("lista------>",str(cpl3_sorted))
print("-----> merge",str(cpl_sorted.merge(cpl3_sorted)))
print("-----------------------------------------------------------")
print(str(cpl))
cpl.reverse()
print(str(cpl))
